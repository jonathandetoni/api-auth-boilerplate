...
-- CreateEnum
CREATE TYPE "TypeUsers" AS ENUM ('COMMON', 'PROFESSIONAL', 'ADMINISTRATOR');
...
-- CreateIndex
CREATE UNIQUE INDEX "addresses_dataBasicUsersId_key" ON "addresses"("dataBasicUsersId");

-- CreateIndex
CREATE UNIQUE INDEX "contacts_id_key" ON "contacts"("id");

-- CreateIndex
CREATE UNIQUE INDEX "contacts_dataBasicUsersId_key" ON "contacts"("dataBasicUsersId");

-- CreateIndex
CREATE UNIQUE INDEX "budgets-sent_id_key" ON "budgets-sent"("id");

-- CreateIndex
CREATE UNIQUE INDEX "budgets-sent_professionalId_key" ON "budgets-sent"("professionalId");
...
-- CreateIndex
CREATE UNIQUE INDEX "budgets_ownerId_key" ON "budgets"("ownerId");
...
-- CreateIndex
CREATE UNIQUE INDEX "comments_demandId_key" ON "comments"("demandId");

-- CreateIndex
CREATE UNIQUE INDEX "comments_ownerCommentId_key" ON "comments"("ownerCommentId");
...
-- AddForeignKey
ALTER TABLE "addresses" ADD CONSTRAINT "addresses_dataBasicUsersId_fkey" FOREIGN KEY ("dataBasicUsersId") REFERENCES "data-basic-users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "budgets" ADD CONSTRAINT "budgets_addressId_fkey" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
